...
public class DiversifyGenerator implements IRandomGenerator{
  ...
  /**
	   * Constructor
	   */
	  public DiversifyGenerator() {
	    this.seed = (new Random(System.nanoTime())).nextDouble();
	  }

	  public DiversifyGenerator(double seed) {
	   // this.seed = seed;
	    this.seed = (new Random((long)seed)).nextDouble();
	    this.randomize();
	   }
